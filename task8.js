/**Skriv en funktion som returnerar hur många
   "likes" bilden på plats x i arrayn har fått */
...
function likesCounter(gallery, item) {
  console.log(gallery[item].likes);
}

likesCounter(images, 1);
